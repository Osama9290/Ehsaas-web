          ...
          <TableBody>
            {foodInfo.map((foodData) => (
              ...
              >
                ...
                <TableCell align="right">{foodData.streetAddress}</TableCell>
                ...
                <TableCell align="right">{foodData.status}</TableCell>
                <TableCell align="right">
          ...
          <TableBody>
            {itemInfo.map((itemData) => (
              ...
              >
                ...
                <TableCell align="right">{itemData.status}</TableCell>
                <TableCell align="right">
                  <Link style={{ textDecoration: "none" }} to={"/chat"}>
                    <Button
                      type="submit"
          ...
          <TableBody>
            {bloodInfo.map((bloodData) => (
              ...
              >
                ...
                <TableCell align="right">{bloodData.status}</TableCell>
                <TableCell align="right">
                  <Link style={{ textDecoration: "none" }} to={"/chat"}>
                    <Button
                      type="submit"
